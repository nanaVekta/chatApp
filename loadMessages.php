...
if(isset($_GET) && isset($_GET["course"]) && isset($_GET['type']) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {

    $item_per_page 		= 30; //item to display per page
//continue only if $_POST is set and it is an Ajax request

    $sender = $_SESSION['c_student_logged'];
...
//Limit our results within a specified range.
    ...
    <script>
        $(document).ready( function( $ ) {
            ...
            $('.message-content').text(function (index, currentText) {
        ...
        <div class="container">
            <div class="row">
                <div class="clearfix">
                    ...
                    <div id="appendMessageAttachment" class="pull-left"></div>
                </div>
