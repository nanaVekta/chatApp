$(document).ready(function(){
    ...
    form.validate({
        ...
        messages:
        {
            ...
            addDepartmentYear: "select year of establishment",
            addDepartmentSchool: "select school"
        },
        submitHandler: submitDepartmentForm
    });

    function submitDepartmentForm() {
        var button = $('#addDepartmentSubmit');
        var errorDiv = $('#addDepartmentError'), data = form.serialize();

        $.ajax({
            type: 'get',
            url: 'submit-department.php',
            data: data,
            beforeSend: function () {
            ...
            success :  function(data) {
                if(data=="inserted") {
                    ...
                    errorDiv.fadeIn(1000, function(){
                        ...
                        errorDiv.html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp;Sorry department already exist in our database!</div>');
